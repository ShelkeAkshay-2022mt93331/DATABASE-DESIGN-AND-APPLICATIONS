...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
			...
			<div style="margin-left:80px"><input type="radio" name="branch" value="other"/>Other<input type="radio" name="branch" value="IT"/>IT</div>
			<div style="margin-left:80px"><input type="radio" name="branch" value="Mech"/>Mech<input type="radio" name="branch" value="Elect"/>Elect</div>
			<div style="margin-left:80px"><input type="radio" name="branch" value="Civil"/>Civil<input type="radio" name="branch" value="Instru"/>Instru</div>
            </div>   
            ...
            <Button class="greenbtn" >ADD NEW STUDENT</Button>
